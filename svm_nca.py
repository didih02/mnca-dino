...
def main(dataset, act_nca, n_component, init_args, fp16, seed):
    ...
    if act_nca:
        ...
        nca_dir = os.path.join(f"classify_nca_init_{init_args}", f"{name_dataset}/{n_component}")
        ...
        utils_custom.svm_classify(name_dataset, x_train, y_train, x_test, y_test, nca_dir, _size_nca, act_nca, 
                                  n_component, init_args, f"classify_nca_init_{init_args}", "nca", seed=seed)
        ...
        utils_custom.svm_classify(name_dataset, x_train, y_train, x_test, y_test, dir, _size, act_nca, n_component, init_args, None, None, seed=seed)
