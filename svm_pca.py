...
def main(dataset, act_pca, n_component, svd_solver_args, fp16, seed):
    ...
    if act_pca:
        ...
        pca_dir = os.path.join(f"classify_pca_svd_solver_{svd_solver_args}", f"{name_dataset}/{n_component}")
        ...
        utils_custom.svm_classify(name_dataset, x_train, y_train, x_test, y_test, pca_dir, _size_pca, act_pca, n_component, svd_solver_args, f"classify_pca_svd_solver_{svd_solver_args}", "pca", seed=seed)

        print("Classify Done")

    else:
        print("Only Classifiers")  
        dir = os.path.join("classify", f"{name_dataset}")
        ...
        utils_custom.svm_classify(name_dataset, x_train, y_train, x_test, y_test, dir, _size, act_pca, n_component, svd_solver_args, None, None, seed=seed)
...
if __name__ == "__main__":
    ...
    #Example:
    #python3 pca.py --dataset cifar10 ==> without PCA
    #python3 pca.py --dataset cifar_10 --act_pca True --n_component 20 --svd_solver randomized --float16 True==> with PCA
