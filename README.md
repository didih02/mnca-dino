...
The tutorial of using our code will be shared later, please be patient :)

MLP and SVM classifiers (done), MNCA classifier for the research (progress), MNCA classifier + Feature Reduction (progress), How to use the code (progress)
